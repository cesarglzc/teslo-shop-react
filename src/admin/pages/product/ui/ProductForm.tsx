              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {
                      errors.stock && (
                        <p className="text-red-500 text-sm">El stock debe ser mayor o igual a 0</p>
                      )
                    }
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    {... register('slug', {
                      required: true,
                      validate: (value) => !/\s/.test(value) || 'El slug no debe contener espacios en blanco'
                    })}
                    className={
                        cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                          {
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className={
                      cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none",
                        {
